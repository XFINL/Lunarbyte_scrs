  ...
  if (submitted) {
    return (
      <GlassCard hover={false} className="p-12 text-center max-w-md mx-auto mt-16">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">提交成功！</h2>
  ...
  return (
    <div className="space-y-8 pt-4 max-w-2xl mx-auto">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">提交站点</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full h-10 px-4 rounded-xl bg-white/10 dark:bg-white/5 backdrop-blur-xl
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 rounded-xl bg-white/10 dark:bg-white/5 backdrop-blur-xl
                border border-white/20 dark:border-white/10 text-gray-900 dark:text-white
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full h-10 px-4 rounded-xl bg-white/10 dark:bg-white/5 backdrop-blur-xl
                  border border-white/20 dark:border-white/10 text-gray-900 dark:text-white text-sm
                  outline-none focus:border-cyan-400/50 transition-colors appearance-none"
              >
                <option value="" disabled>选择分类</option>
                {categories.map((cat) => (
                  <option key={cat.id} value={cat.id} className="dark:bg-gray-900 bg-white">{cat.icon} {cat.name}</option>
                ))}
              </select>
            </div>
            <div className="space-y-1.5">
